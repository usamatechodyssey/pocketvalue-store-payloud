// //whishlist page ke liye client component banaya hai taake hum state aur effects ka use kar sakein. Isme hum user ke wishlist items ko fetch karenge, unke live product data ko get karenge, aur pagination aur quick view modal bhi implement karenge. Loading state aur empty state ke liye bhi proper handling ki gayi hai taake user experience smooth ho.
